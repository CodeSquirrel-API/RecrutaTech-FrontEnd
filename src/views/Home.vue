<template>
  ...
  <div class="home">
    ...
    <div v-if="carregandoConhecimento" v-html="loading" class="loading-icon"></div>
...
export default {
  ...
  methods: {
    async getCargoGpt() {
      this.carregandoConhecimento = true;
      ...
      this.carregandoConhecimento = false; // Desativar o indicador de carregamento
    }
    },
